...
@patch('core.sql_scanner.requests.get')
def test_sql_ne_trouve_rien_sur_site_securise(mock_get):
    ...
    resultats = start_sql_scanner("http://mon-site.com/page.php?id=1")
...
@patch('core.sql_scanner.requests.get')
def test_sql_detecte_faille_sql(mock_get):
